...
public class SocketManager {
    ...
    public static void receive(int arPort, Server server)
    {
        if (SOCKET_BY_SCTP)
        {
    ...
    private static void receiveByTCP(int arPort, Server server)
    {
        String message = "";
        try
        {
    ...
    private static void receiveBySCTP(int arPort, Server obj)
    {
